    ...
    <div className="px-6 pb-24 pt-[120px] sm:px-8">
      <div className="mx-auto max-w-5xl space-y-14">
        <section className="rounded-[36px] border border-white/10 bg-[#08101f]/90 p-10 shadow-soft backdrop-blur-xl">
          <SectionHeading
            eyebrow="Contact"
            title="Partner with us to build the next generation of adaptive AI infrastructure."
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {[
              { icon: Briefcase, title: 'Enterprise inquiry', detail: 'partner@novamind.ai' },
              { icon: MessageCircle, title: 'Investor relations', detail: 'invest@novamind.ai' },
              { icon: AtSign, title: 'General inquiry', detail: 'hello@novamind.ai' },
            ].map((item) => (
